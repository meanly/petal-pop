...
public class Flowers : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        gameStats.flowers += gameStats.flowersPerClickTotal;
        gameStats.handmadeFlowers += gameStats.flowersPerClickTotal;
    }
    ...
    void OnMouseOver()
    { // while mouse on me
        float newSizeDesired = Input.GetMouseButton(0) && !onFlowerClick ? 0.98f : 1.05f;
